...
class _ChatScreenState extends State<ChatScreen> {
  ...
  void _sendMessage({String text, File imgFile}) async{
      ...
      if(imgFile != null){
          StorageUploadTask task = FirebaseStorage.instance.ref().child("fotos").child(user.uid + DateTime.now().millisecondsSinceEpoch.toString()).putFile(imgFile);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        key: _scaffoldKey,
        appBar: AppBar(
          title:Text(_currentUser != null ? "Ola ,${_currentUser.displayName}" : "Chat App"),
          elevation: 0,
          centerTitle: true,
          actions: <Widget>[
            _currentUser != null ? IconButton(
                ...
                onPressed: (){
                    ...
                    _scaffoldKey.currentState.showSnackBar(
                      SnackBar(
                        content: Text("Voçê saiu com sucesso!"),
